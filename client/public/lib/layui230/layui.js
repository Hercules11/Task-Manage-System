...
!(function (e) {
  ...
  (o.prototype.cache = n),
      ...
      function s(e, t) {
        var o =
          "PLaySTATION 3" === navigator.platform
            ...
            : /^(complete|loaded)$/;
        ("load" === e.type ||
          o.test((e.currentTarget || e.srcElement).readyState)) &&
          ((n.modules[d] = t),
          f.removeChild(v),
          (function r() {
            return ++m > (1e3 * n.timeout) / 4
              ? a(d + " is not a valid module")
              : void (n.status[d] ? c() : setTimeout(r, 4));
          })());
      }
      function c() {
        l.push(layui[d]),
    ...
    (o.prototype.data = function (t, n, o) {
      if (
        ((t = t || "layui"), (o = o || localStorage), e.JSON && e.JSON.parse)
      ) {
    ...
    (o.prototype.event = o.event = function (e, t, o, r) {
      ...
      return r
        ? ((n.event[l] = n.event[l] || {}), (n.event[l][s] = [r]), this)
